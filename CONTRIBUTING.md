...
- Fork the repository
- Create a branch from dev, not main: git checkout -b feature/your-feature-name
- Make your changes
- Write or update tests if applicable
- Run the project locally and confirm it works
- Submit a PR into the dev branch, never directly into main
